...
/* Accessibility enhancements for PSPC */
// TODO: make this bilingual
var resultsMsgEn = ' records found. Use arrow keys to select.';
var resultsMsgFr = ' resultats trouver. Utiliser les touches fléchées pour selectionner.';

$('body').append('<div id="screen-reader" lang="' + $('html').attr('lang') + '" aria-live="polite" class="wb-inv"></div>');
            ...
            afterFiltered = function() {
              ...
              //announce selection to screen reader
                if ($('html').attr('lang') == 'en') {
                    ...
                    $('#screen-reader').text($item.length + resultsMsgFr + ' ' + $item.filter('.selected').text());
                }
                else {
                    console.error('Language setting not found. Please add a lang attribute (fr/en) to the html tag!');
                }
            }
          ;
            ...
            if(isShortcutKey) {
              ...
              if( module.is.visible() ) {
                ...
                if(pressedKey == keys.upArrow) {
                  ...
                  ;
                  //announce selection to screen reader
                  $('#screen-reader').text($nextItem.text());
          ...
          if( module.is.visible() ) {
            if(keyCode == keys.enter) {
              ...
              newIndex = (currentIndex - 1 < 0)
                ...
                //announce selection to screen reader
                $('#screen-reader').text($result.eq(newIndex).text());
          ...
          response: function(response, searchTerm) {
            ...
            if(response !== undefined) {
              if(searchTerm !== undefined && response[fields.results] !== undefined) {
                ...
                //announce selection to screen reader
                  if ($('html').attr('lang') == 'en') {
                      $('#screen-reader').text($results.find('.result').length + resultsMsgEn); 
                  }
                  else if ($('html').attr('lang') == 'fr') {
                      $('#screen-reader').text($results.find('.result').length + resultsMsgFr); 
                  }
                  else {
                      console.error('Language setting not found. Please add a lang attribute (fr/en) to the html tag!');
                  }
